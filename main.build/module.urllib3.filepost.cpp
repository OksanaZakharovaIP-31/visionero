...
static PyObject *impl_urllib3$filepost$$$function__1_choose_boundary(PyThreadState *tstate, struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
...
#endif
        cache_frame_8dcba6ff632db9425d40352292678e26 = MAKE_FUNCTION_FRAME(tstate, codeobj_8dcba6ff632db9425d40352292678e26, module_urllib3$filepost, sizeof(void *));
#if _DEBUG_REFCOUNTS
    } else {
    ...
    // owning it.
    pushFrameStackCompiledFrame(tstate, frame_8dcba6ff632db9425d40352292678e26);
...
static PyObject *urllib3$filepost$$$function__2_iter_field_objects$$$genobj__1_iter_field_objects_context(PyThreadState *tstate, struct Nuitka_GeneratorObject *generator, PyObject *yield_return_value) {
    ...
    if (isFrameUnusable(cache_m_frame)) {
        ...
        count_allocated_frame_cache_instances += 1;
#endif
        cache_m_frame = MAKE_FUNCTION_FRAME(tstate, codeobj_50fa43b756064b323cbe9d7c5c889448, module_urllib3$filepost, sizeof(void *)+sizeof(void *)+sizeof(void *));
#if _DEBUG_REFCOUNTS
    } else {
        count_hit_frame_cache_instances += 1;
#endif
    ...
    branch_no_2:;
    {
...

        {
            ...
            tmp_expression_value_3 = impl___main__$$$function__7_complex_call_helper_star_list(tstate, dir_call_args);
        }
...
static PyObject *impl_urllib3$filepost$$$function__3_iter_fields(PyThreadState *tstate, struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    if (isFrameUnusable(cache_frame_68a09e641193e6531e5408e93c21a40b)) {
        ...
        count_allocated_frame_cache_instances += 1;
#endif
        cache_frame_68a09e641193e6531e5408e93c21a40b = MAKE_FUNCTION_FRAME(tstate, codeobj_68a09e641193e6531e5408e93c21a40b, module_urllib3$filepost, sizeof(void *));
#if _DEBUG_REFCOUNTS
    } else {
        count_hit_frame_cache_instances += 1;
#endif
    ...
    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStackCompiledFrame(tstate, frame_68a09e641193e6531e5408e93c21a40b);
...
static PyObject *urllib3$filepost$$$function__3_iter_fields$$$genexpr__1_genexpr_context(PyThreadState *tstate, struct Nuitka_GeneratorObject *generator, PyObject *yield_return_value) {
    ...
    if (isFrameUnusable(cache_m_frame)) {
        ...
        count_allocated_frame_cache_instances += 1;
#endif
        cache_m_frame = MAKE_FUNCTION_FRAME(tstate, codeobj_919de258d8c460d3113269ffa1cff1a6, module_urllib3$filepost, sizeof(void *)+sizeof(void *)+sizeof(void *));
#if _DEBUG_REFCOUNTS
    } else {
        count_hit_frame_cache_instances += 1;
#endif
...
static PyObject *urllib3$filepost$$$function__3_iter_fields$$$genexpr__2_genexpr_context(PyThreadState *tstate, struct Nuitka_GeneratorObject *generator, PyObject *yield_return_value) {
    ...
    if (isFrameUnusable(cache_m_frame)) {
        ...
        count_allocated_frame_cache_instances += 1;
#endif
        cache_m_frame = MAKE_FUNCTION_FRAME(tstate, codeobj_bbf0a56805c34fabf37d95e75c4c737d, module_urllib3$filepost, sizeof(void *)+sizeof(void *)+sizeof(void *));
#if _DEBUG_REFCOUNTS
    } else {
        count_hit_frame_cache_instances += 1;
#endif
...
static PyObject *impl_urllib3$filepost$$$function__4_encode_multipart_formdata(PyThreadState *tstate, struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    if (isFrameUnusable(cache_frame_03a6959bcaac2f4c0a4118084dcb3f7f)) {
        ...
        count_allocated_frame_cache_instances += 1;
#endif
        cache_frame_03a6959bcaac2f4c0a4118084dcb3f7f = MAKE_FUNCTION_FRAME(tstate, codeobj_03a6959bcaac2f4c0a4118084dcb3f7f, module_urllib3$filepost, sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *));
#if _DEBUG_REFCOUNTS
    } else {
        count_hit_frame_cache_instances += 1;
#endif
    ...
    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStackCompiledFrame(tstate, frame_03a6959bcaac2f4c0a4118084dcb3f7f);
...
// Mark the execution in the "__spec__" value.
    ...
    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStackCompiledFrame(tstate, frame_af45c61c9eb972fdae6b6c2834dde4ca);
