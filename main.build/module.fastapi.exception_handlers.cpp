...
static void createModuleConstants(PyThreadState *tstate) {
    if (constants_created == false) {
        loadConstantsBlob(tstate, &mod_consts[0], UNTRANSLATE("fastapi.exception_handlers"));
...
#ifndef __NUITKA_NO_ASSERT__
void checkModuleConstants_fastapi$exception_handlers(PyThreadState *tstate) {
...
static PyObject *MAKE_COROUTINE_fastapi$exception_handlers$$$function__1_http_exception_handler$$$coroutine__1_http_exception_handler(PyThreadState *tstate, struct Nuitka_CellObject **closure);


static PyObject *MAKE_COROUTINE_fastapi$exception_handlers$$$function__2_request_validation_exception_handler$$$coroutine__1_request_validation_exception_handler(PyThreadState *tstate, struct Nuitka_CellObject **closure);
...
static PyObject *impl_fastapi$exception_handlers$$$function__1_http_exception_handler(PyThreadState *tstate, struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    // Actual function body.
    {
        ...
        tmp_return_value = MAKE_COROUTINE_fastapi$exception_handlers$$$function__1_http_exception_handler$$$coroutine__1_http_exception_handler(tstate, tmp_closure_1);
...
static PyObject *fastapi$exception_handlers$$$function__1_http_exception_handler$$$coroutine__1_http_exception_handler_context(PyThreadState *tstate, struct Nuitka_CoroutineObject *coroutine, PyObject *yield_return_value) {
...
#endif
        cache_m_frame = MAKE_FUNCTION_FRAME(tstate, codeobj_61a9db7c92fae374dd80527d1c081465, module_fastapi$exception_handlers, sizeof(void *)+sizeof(void *)+sizeof(void *));
#if _DEBUG_REFCOUNTS
    } else {
    ...
    branch_yes_1:;
    {
        ...
        coroutine->m_frame->m_frame.f_lineno = 13;
        {
            ...
            coroutine_heap->tmp_return_value = CALL_FUNCTION_WITH_NO_ARGS_KWSPLIT(tstate, tmp_called_value_2, kw_values, mod_consts[5]);
        }
    ...
    branch_no_1:;
    {
        ...
        coroutine->m_frame->m_frame.f_lineno = 14;
        {
            ...
            coroutine_heap->tmp_return_value = CALL_FUNCTION_WITH_ARGS1_KWSPLIT(tstate, tmp_called_value_3, args, kw_values, mod_consts[5]);
        }
...
static PyObject *impl_fastapi$exception_handlers$$$function__2_request_validation_exception_handler(PyThreadState *tstate, struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    // Preserve error status for checks
#ifndef __NUITKA_NO_ASSERT__
    NUITKA_MAY_BE_UNUSED bool had_error = HAS_ERROR_OCCURRED(tstate);
#endif
    ...
    // Actual function body.
    {
        ...
        tmp_return_value = MAKE_COROUTINE_fastapi$exception_handlers$$$function__2_request_validation_exception_handler$$$coroutine__1_request_validation_exception_handler(tstate, tmp_closure_1);
...
static PyObject *fastapi$exception_handlers$$$function__2_request_validation_exception_handler$$$coroutine__1_request_validation_exception_handler_context(PyThreadState *tstate, struct Nuitka_CoroutineObject *coroutine, PyObject *yield_return_value) {
    CHECK_OBJECT(coroutine);
    assert(Nuitka_Coroutine_Check((PyObject *)coroutine));
    CHECK_OBJECT_X(yield_return_value);
    ...
    if (isFrameUnusable(cache_m_frame)) {
        ...
        count_allocated_frame_cache_instances += 1;
#endif
        cache_m_frame = MAKE_FUNCTION_FRAME(tstate, codeobj_cd6b75db4dca109f74b1c3869e25b572, module_fastapi$exception_handlers, sizeof(void *)+sizeof(void *));
#if _DEBUG_REFCOUNTS
    } else {
        count_hit_frame_cache_instances += 1;
#endif
    ...
    // Framed code:
    {
        ...
        coroutine->m_frame->m_frame.f_lineno = 22;
        {
            ...
            coroutine_heap->tmp_return_value = CALL_FUNCTION_WITH_NO_ARGS_KWSPLIT(tstate, tmp_called_value_1, kw_values, mod_consts[12]);
        }
...
PyObject *modulecode_fastapi$exception_handlers(PyThreadState *tstate, PyObject *module, struct Nuitka_MetaPathBasedLoaderEntry const *loader_entry) {
    // Report entry to PGO.
    ...
    if (init_done == false) {
        ...
        NUITKA_PRINT_TRACE("fastapi.exception_handlers: Calling createModuleConstants().\n");
        createModuleConstants(tstate);
...
// Set the "__spec__" value
    ...
    // Other modules get a "ModuleSpec" from the standard mechanism.
    {
        ...
        PyObject *spec_value = CALL_FUNCTION_WITH_SINGLE_ARG(tstate, _spec_from_module, module_fastapi$exception_handlers);
...
// Mark the execution in the "__spec__" value.
    ...
    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStackCompiledFrame(tstate, frame_c2fa20836e4f1132d82638bb29c15320);
